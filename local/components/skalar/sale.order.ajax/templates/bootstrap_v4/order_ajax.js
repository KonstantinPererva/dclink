	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
				...
				buttons.push(
					BX.create('button', {
						props: {
							...
							className: 'pull-left btn btn-primary btn-md'
						},
			...
			if (!isLastNode)
			{
				buttons.push(
					BX.create('button', {
						props: {href: 'javascript:void(0)', className: 'pull-right btn btn-primary btn-md'},
		...
		editBasketItemsHeader: function(basketItemsNode)
		{
			...
			basketItemsNode.appendChild(
				BX.create('DIV', {
					props: {className: 'bx-soa-item-tr d-none d-md-block'},
					children: headers
				})
			);
		},
		...
		createPaySystemItem: function(item)
		{
			...
			itemNode = BX.create('DIV', {
				props: {className: 'bx-soa-pp-company col-lg-4 col-6'},
		...
		createDeliveryItem: function(item)
		{
			...
			itemNode = BX.create('DIV', {
				props: {className: 'bx-soa-pp-company col-lg-4 col-sm-4 col-6'},
				children: [label, title],
