...
class SaleOrderAjax extends \CBitrixComponent
{
	...
	protected function obtainRelatedProperties()
	{
		...
		$arDeliverySystemId = $this->getDeliveryIds($this->order);
	...
	protected function initOrderFields(Order $order)
	{
		if ($this->isOrderConfirmed)
		{
			...
			$deliverySystemIds = $this->getDeliveryIds($order);
	...
	protected function getJsDataResult()
	{
		...
		$deliverySystemIds = $this->getDeliveryIds($this->order);
	...
	public static function getWarehouses($arDelivery, $arLocation){
		global $APPLICATION;
	...
	public function executeComponent()
	{
		...
		//print_log("arResult", "/log/order.txt");
		//print_log($this->arResult, "/log/order.txt");
		//print_log($arProperty, "/log/order.txt");
