...
?>
<?$this->SetViewTarget('catalog_filter');// вызов отложенной функции ниже по коду в текущем файле?>
<? if ($isFilter || $isSidebar): ?>
		</div>
	</div>
	<div class="bx-content_right <?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
...
<? $APPLICATION->ShowViewContent('catalog_filter'); // отложенная функция выше по коду в текущем файле ?>
